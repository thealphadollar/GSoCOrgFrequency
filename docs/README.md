The following table contains the organisations that have been part of Google Summer of Code at least once from 2009 to 2024 - number of times they have participated, technologies they use, topics they work on, GSoC category, and the latest GSoC year they participated in.
...
| 52° North GmbH | 2 | python,  javascript,  java,  web services, javascript, react,  ogc standards, android, java |  geoinformation systems, floating car data, trajectory analytics,  open standards, ogc standards, citizen science, web services,  spatial information infrastructures | Science and Medicine | 2021 |
| 52°North Initiative for Geospatial Open Source Software GmbH | 8 | r, web, spring, javascript, bigdata, webservices, android, ogcstandards, java | spatial information, spatial data infrastructures, web-based geoprocessing, floating car data, geoinformatics, spatial data, sensorweb, sensor web, remote sensing, geoprocessing, web processing, earth observation, ogc, geostatistics | Science and Medicine | 2019 |
| 52°North Spatial Information Research GmbH | 3 |  android,  web services,  java, javascript,  ogc standards |  open standards,  data analytics,  spatial information infrastructures, citizen science,  Geoinformation |  | 2024 |
| AbiWord | 5 |  |  |  | 2013 |
| AboutCode | 5 |  django, python,  javascript, javascript,  Django+PostgreSQL, c/c++, shellscript,  C/Rust/Go,  postgres, staticanalysis | code scan and matching,  scanning, software composition analysis, code analysis and spdx, dependencies,  vulnerabilities,  software packages, package and dependencies licensing and origin,  SBOM,  SoftwareCompositionAnalysis,  License, free and open source software  license and origin, package vulnerabilities and security | Programming Languages and Development Tools | 2024 |
| AboutCode.org | 2 | python, postgresql, search, javascript, c/c++, rust, automaton, nlp | machine learning, software analysis, copyright, dependencies, package managers, license-scan, oss licensing, application security, license compliance | Programming Languages and Development Tools | 2020 |
| Academy Software Foundation | 1 | c,  python,  opengl,  c++,  rust | graphics,  media,  animation,  Visual Effects,  Film |  | 2022 |
...
| Accord Project | 3 | compiler,  coq, python,  javascript,  artificial intelligence, javascript, react, ocaml, coq,  react,  compiler,  ocaml,  rust | smart contracts, blockchain,  data modeling,  legal, legal, compilers, ai,  contract management,  document assembly,  blockchain, natural language processing,  ai,  smart contracts,  legal technology | Programming Languages and Development Tools | 2024 |
| AerospaceResearch.Net | 7 |  sqlite, python, boinc,  raspberry pi, raspberrypi, vhdl, sqlite, c/c++,  machine learning, c++,  sdr, java |  signal processing, software defined radio, distributed computing,  simulations,  software defined radio, simulations, space applications, cubesats,  cubesats | Science and Medicine | 2021 |
| afl++ | 1 | fuzzing, c/c++, qemu, llvm, sanitizers | bug finding, software testing, fuzzing | Security | 2020 |
| AFLplusplus | 4 | llvm,  llvm,  qemu,  fuzzing, c/c++,  rust,  instrumentation | fuzzing,  ci,  secure development,  instrumentation |  | 2024 |
| Africa Soil Information Service | 1 |  |  |  | 2015 |
| aimacode | 4 | python, machinelearning, ai, python3, javascript, jupyter, artificialintelligence, java | machine learning,  education, open education, artificial intelligence, education | Programming Languages and Development Tools | 2019 |
| Alaska | 1 | python,  mysql,  java,  matlab,  dicom | deep learning,  neuroscience,  radiology,  heathcare,  Polar Science |  | 2024 |
| Amahi | 5 | streaming, rubyonrails, javascript, containers, android, restfulapi, golang, ios, swift | streaming,  web apps, mobile streaming,  web servers, storage server, webapps,  networking, backups, networking, media server, front-end, web apps, operating systems, home servers, mobile-apps, storage | Operating Systems | 2020 |
| Android Graphics Tools Team | 3 |  opengl,  spir-v, vulkan,  webgpu, python3, c/c++, spir-v,  c++, opengl, java | profiling, debugging,  fuzzing,  graphics, bug finding, developer tools, testing,  developer tools, 2d/3d graphics | Programming Languages and Development Tools | 2021 |
| AnitaB.org Open Source | 1 | ios, android, python, javascript | mobile,  web, mobile programming, web programming | Other | 2020 |
| AnkiDroid | 3 |  android,  mobile,  gradle,  java, javascript,  rust, android,  kotlin |  android,  mobile,  Flashcards,  user generated content,  flashcard, education |  | 2024 |
| Ankur India | 2 |  |  |  | 2013 |
| AOSSIE | 5 |  scala, kotlin,  android, python,  javascript, javascript,  ios,  Blockchain,  machine learning,  flutter, swift | machine learning, social science, environment,  mobile,  electronic voting, web,  backend,  machine learning, natural language processing,  social science,  natural language processing, electronic voting | End User Applications | 2024 |
| AOSSIE - Australian Open Source Software Innovation and Education | 3 | automatedreasoning, android/ios, browserextension, xcode, javascript, isabelleproofassistant, javascript/html5/css3, ios, android, javascript/html/css, scala | machine learning, environment, philosophy, natural language processing, electronic voting, logic | End User Applications | 2019 |
...
| City of Boston | 1 | python,  javascript | web,  machine learning,  gis,  civic tech,  analytics |  | 2024 |
...
| CVAT | 1 | python,  django,  react,  kubernetes,  typescript | machine learning,  computer vision,  ai,  deep learning,  data |  | 2024 |
...
| HumanAI | 1 | python,  machine learning,  c++,  data analysis,  artificial intelligence | machine learning,  artificial intelligence,  ai,  Arts,  Humanities |  | 2024 |
...
| Kotlin Foundation | 2 |  jvm,  Parsers & Compilers,  Multiplatform, gradle,  kotlin | compilers,  programming languages,  libraries,  software development,  Programming & Build Tools |  | 2024 |
...
| MapAction | 1 | python,  data analysis,  gis,  apache airflow,  visualization | humanitarian,  maps,  geospatial,  data processing,  google cloud |  | 2021 |
| Mapnik | 2 |  |  |  | 2011 |
...
| OMII-UK | 2 |  |  |  | 2010 |
| OncoBlocks | 1 |  |  |  | 2015 |
| Open Bioinformatics Foundation | 9 | haskell, python, ruby, perl, php,  javascript, javascript, c,  python, c/c++,  react, c++,  c++, java, d, biojs | computational biology,  bioinformatics, genomics,  web, bioinformatics,  workflows | Science and Medicine | 2021 |
...
| PEcAn Project | 8 | r, python,  api, docker, php,  geospatial, postgresql,  r, javascript, c,  docker, singularity, kubernetes,  kubernetes | scientific visualization, ecological forecasting,  ecological forecasting, data science,  scientific visualization,  Ecological Forecasting, climate science,  data science,  climate science,  ecosystem models, ecosystem models | Science and Medicine | 2024 |
...
| Percona | 2 | grafana, mysql, postgresql, javascript, shellscript, golang, prometheus, selenium | monitoring, data visualization, metrics, load testing, databases, alerts, testing, database optimization, automation | Data and Databases | 2020 |
| Performance Co-Pilot | 6 | windows, python, grafana, ruby, linuxkernel, javascript, c,  redis,  grafana, libuv, linux, java, golang,  htop,  sysstat, redis, rest | monitoring, performance, realtime messaging, visualization,  web development, timeseries,  visualization, high performance computing,  distributed,  performance,  observability, kernel, lightweight, metrics, web development, data analysis, analysis, distributed | Operating Systems | 2022 |
| Pharo Consortium | 4 | polymath, smalltalk, squeak, pharo,  SUnit,  smalltalk,  spec,  roassal,  pharo, ide, git, os, roassal | machine learning, material design,  visualization,  Modelling, compilers, data science,  programming languages,  ide, cli, user interface,  virtual machines, web development, ide,  ai, dynamic environment, nlp, object oriented programming | Programming Languages and Development Tools | 2023 |
| PHP | 1 |  |  |  | 2009 |
| phpBB Forum Software | 5 | php, symfony, css, mysql, html5/css3, javascript | communication, collaboration, forum, community, social | Social / Communications | 2018 |
| phpMyAdmin | 9 | bootstrap, jquery, mysql, php, javascript, cakephp | developer, administrator, mysql, web application, web applications, database | Data and Databases | 2019 |
| Physical Web Project | 2 | beacon, python, internetofthings, webbluetooth, bluetooth, beacons, physicalweb, arduino | beacons, internet of things, web apps, mobile | Other | 2017 |
| Pidgin Instant Messenger | 1 | c,  gtk,  gstreamer | web,  real time,  video,  chat,  voice |  | 2021 |
| Pidgin, Finch and libpurple | 5 |  |  |  | 2015 |
| Pitivi | 4 | gtk, python3, c,  python, gstreamer,  gstreamer,  gtk | filmmaking,  video processing, video editing,  video editing, video processing,  filmmaking | Graphics / Video / Audio / Virtual Reality | 2023 |
| PiTiVi video editor | 1 |  |  |  | 2013 |
| PKIF project | 1 |  |  |  | 2009 |
| Plan 9 Foundation | 1 | c,  golang,  distributed systems,  concurrency | operating systems,  distributed systems,  network programming |  | 2021 |
| Plan 9 from Bell Labs | 5 |  |  |  | 2014 |
| PLASMA @ UMass | 3 | go, javascript, c/c++, scala | programming languages, programming tools, runtime systems, software engineering, operating systems | Programming Languages and Development Tools | 2016 |
| Plone | 1 | python, javascript, html, css, reactjs | communications, collaboration, content management, web | Web | 2018 |
| Plone Foundation | 10 | html/css, python,  javascript, zope, javascript, nosql,  react, rest | web, cms,  content management,  cms, enterprise applications, content management | Web | 2024 |
| PLSE at UW | 1 |  |  |  | 2010 |
| PMD | 2 | xml, javacc, antlr, xpath, java | code analysis, source code analyzer, linter, code quality | Programming Languages and Development Tools | 2018 |
| Pocket Science Lab | 1 | android, java, firmware, c, cad | science, education, firmware, school apps | Science and Medicine | 2018 |
| Point Cloud Library | 2 | cpp,  c++14, python, cmake,  cmake, devops,  cuda,  computer vision |  robotics,  2d/3d graphics, robotics, 3d computer vision, perception,  computer vision,  data structures,  gpu computing | Graphics / Video / Audio / Virtual Reality | 2021 |
| Point Cloud Library (PCL) | 3 |  |  |  | 2014 |
| Polly Labs | 2 | llvm, integersetlibrary, isl, c/c++, ppcg, polly, pencil | parallelization, program verification, fpga, compilers, polyhedral compilation, polyhedral model, optimization | Programming Languages and Development Tools | 2018 |
| Polypheny | 3 |  java,  sql,  angular, javascript |  nosql, databases,  big data,  ui,  polystore,  cloud, database |  | 2024 |
...
| PostgreSQL | 9 |  sql,  postgresql, postgres,  javascript, perl, postgresql,  julia, c, ordbms,  python, sql,  perl, rdbms,  go |  sql,  postgresql, database,  data, web,  relational database, big data,  Benchmark, data management,  ui, sql, rdbms, data,  database | Data and Databases | 2024 |
| PostgreSQL Global Development Group | 1 |  |  |  | 2011 |
| PostgreSQL Project | 4 |  |  |  | 2015 |
| Postman | 4 |  graphql,  api,  AsyncAPI, javascript,  rest api, node.js,  openapi,  node.js,  JSON Schema | productivity,  programming languages and development tools,  apis,  data,  api,  documentation, api, programmer productivity,  software development,  automation, testing, api management,  api management,  developer tools | Programming Languages and Development Tools | 2024 |
| PowerDNS | 1 | c++,  DNS | DNS recursive solutions,  Authoritative DNS software |  | 2022 |
| Princeton Center for Information Technology Policy | 1 |  |  |  | 2010 |
| PRISM Model Checker | 3 | c++, java | verification, science, probabilistic models | Science and Medicine | 2016 |
...
| Processing | 3 |  |  |  | 2013 |
| Processing Foundation | 4 |  opengl,  android, python,  javascr,  javascript,  java, javascript, android, opengl, java | web,  education,  design,  web,  graphics, graphics,  creative coding, education, creative coding, design | Programming Languages and Development Tools | 2023 |
| Project Mesa | 1 | python,  javascript | Agent Based Models,  Generative Science |  | 2024 |
| Project PANOPTES | 1 | python3, arduino, cloud | astronomy, robotics, exoplanet, image processing | Science and Medicine | 2019 |
| Project Tox | 1 |  |  |  | 2014 |
| Project WikiLoop | 1 | python,  java,  mediawiki | cultural heritage,  knowledge graphs,  computer-assisted translation |  | 2021 |
| Prometheus-Operator | 1 | prometheus,  go,  kubernetes,  kubernetes operators | monitoring,  cloud,  observability,  Kubernetes Operator |  | 2024 |
| Ptolemy Project, University of California, Berkeley | 1 |  |  |  | 2009 |
| Public Lab | 6 | rubyonrails, ruby, raspberrypi, webrtc, javascript, node.js,  node, leaflet,  ruby on rails | environment,  environment, pollution,  diy,  documentation,  forum, collaboration,  community, science, hardware, community,  diversity | Science and Medicine | 2022 |
| Public Laboratory for Open Technology and Science | 2 |  |  |  | 2014 |
| PulseAudio | 2 |  |  |  | 2013 |
| Puppet (Reductive Labs) | 1 |  |  |  | 2010 |
| Puppet Labs | 1 |  |  |  | 2012 |
| Purr Data | 7 |  css,  html5,  javascript,  Emscripten, html5/css3, javascript, c, c/c++, html5, node.js,  c++, opengl,  html, svg | music, visual programming, audio,  graphics,  realtime,  audio, digital signal processing,  real-time, real-time,  graphics / video / audio / virtual reality, dsp, 2d/3d graphics, web, real-time system, web development,  visual programming, data visualization, video, data vizualisation | Graphics / Video / Audio / Virtual Reality | 2024 |
...
| Python Software Foundation | 16 | python, mercurial,  javascript,  c++,  SBOM | machine learning, programming languages,  visualization, biology, ui design,  science, physics, hardware, science,  Backup,  modeling,  compiler, mathematics,  science and medicine, image analysis, security | Programming Languages and Development Tools | 2024 |
| QC-Devs | 1 | python,  github,  c++,  julia,  jupyter | data science,  scientific visualization,  quantum chemistry,  Computational Science,  numerical algorithms |  | 2024 |
| Qdrant | 1 | python,  javascript,  rust | databases,  machine learning,  Search Engines |  | 2023 |
| QEMU | 10 | virtualization, python, c,  python,  linux, rust, linux, kvm,  rust, assembly | virtualization, compiler, emulation,  emulator, compilers, hypervisor, lowlevel,  code generation, kernel,  hypervisor,  kernel, cloud,  lowlevel, systems programming, emulator,  compiler, code generation, operating systems | Cloud | 2023 |
| QEMU development team | 1 |  |  |  | 2010 |
| QEMU.org | 2 |  |  |  | 2013 |
| Quagga @ OpenSourceRouting / ISC | 1 |  |  |  | 2013 |
| Qubes OS | 3 | xen, python, c, shell,  python,  shell, linux,  ruby | virtualization,  privacy, privacy, operating system,  security, security, operating systems | Operating Systems | 2021 |
...
| R Project for Statistical Computing | 14 | r,  javascript,  fortran, javascript, c,  r-project, fortran, c++,  c++, r-project | machine learning, data visualization, statistics,  statistics, visualization, data science,  data science,  machine learning,  graphics, graphics | Programming Languages and Development Tools | 2024 |
| RADAR-base | 1 | java,  kotlin,  docker,  angular,  kafka | web,  mhealth,  remote patient monitoring,  micro-services,  devices |  | 2022 |
| radare | 3 | cpp, python, qt, go, c, rust, c++ | reverse engineering, debugging, program analysis, disassembly, assembly, security, decompilation | Security | 2020 |
| radare2 | 1 | c, rust, python, nodejs | reverse engineering | Security | 2017 |
| Raxa | 3 |  |  |  | 2014 |
| React Native Elements | 1 | javascript,  react,  react native | ui toolkit,  design system |  | 2021 |
| ReactOS | 7 | win32, php,  nt, c, c/c++,  win32, c++, nt,  c++ | windows,  drivers, kernel,  kernel, web services, applications,  applications, drivers,  windows, desktop, operating systems | Operating Systems | 2021 |
| ReactOS Foundation | 1 | c,  c++,  win32,  nt | operating systems,  kernel,  drivers,  windows,  system programming |  | 2022 |
| Read the Docs | 2 | elasticsearch, python, django, sphinx, javascript, documentation | communications, documentation, docs, web | Programming Languages and Development Tools | 2019 |
| Red Hen Lab | 10 | python, audioprocessing, singularity,  machine learning, nlp, machinelearning, scikit-learn, highperformancecomputing, opencv,  nlp,  computer vision, datascience, syntaxnet,  ai, audioprocesing, asr, multimodalanalysis,  machinelearning, tensorflow,  data science,  big data science | big data visualization, big data, data science, cognitive science, artificial intelligence,  language, deep learning, metadata,  ai, ai, audio processing, natural language processing, machine learning, communication, multimedia,  multimodal communication,  gesture, co-speech gesture, video processing,  media | Science and Medicine | 2024 |
| Responsible AI and Human Centred Technology | 1 | python,  javascript,  Technical writing | machine learning,  ai,  Fairness,  Robustness,  Safety,  Interpretibility |  | 2022 |
| Review Board | 4 |  |  |  | 2012 |
| RIOT | 1 |  |  |  | 2015 |
| Rizin | 4 | c,  python,  qt,  c++,  go | reverse engineering,  emulation,  debugging,  computer security,  disassembly |  | 2024 |
| RoboComp | 9 |  qt5, python, openscenegraph, cmake,  opencv, qt, ice-zeroc, opencv,  c++, gnu/linux, zerocice, c/c++,  qt,  pytorch, c++, c++11,  c++17, component-baseddevelopment | computer vision, framework, component-based development,  robotics,  multi-agent system,  Multi-agent Systems, robotics simulation, simulation, robotics,  computer vision, multi-agent system,  component-based development | Other | 2022 |
| Robolectric | 2 | android,  jvm,  java,  asm | testing,  mobile |  | 2024 |
| Rockbox | 3 |  |  |  | 2011 |
| Rocket.Chat | 8 |  nodejs,  typescript,  react native, react, ios,  kubernetes, chatbots, meteor.js,  LLM, ruby,  docker, reactnative, node,  generative ai, mongo, javascript,  node, webrtc, node.js, android | realtime communications, collaboration, chatbot,  messaging,  group chat, progressive web apps, instant messaging,  community, chatops, social-network, communications, bot,  Team Collaboration,  Chat platform, chat, realtime, team chat,  communication, machine learning, communication,  instant messaging,  team | Social / Communications | 2024 |
| RooStats | 1 |  |  |  | 2012 |
| RouteFlow | 3 |  |  |  | 2015 |
| Rspamd | 2 | machinelearning, cmake, javascript, c, lua | machine learning, high performance computing, spam filtering, email | Security | 2018 |
| Rspamd spam filtering system | 1 |  |  |  | 2015 |
| RTEMS Project | 16 | bsdunix, python, embeddedsystems,  posix, c, posix,  assembly, c/c++,  bsd unix, waf, assembly,  c/c++ | iot,  embedded,  rtos,  multicore, posix, kernel, operating system,  kernel, embedded systems,  real-time, real time,  embedded systems,  iot cps, multicore | Operating Systems | 2024 |
| Ruby | 8 | ruby, ruby on rails,  java, c,  rubygems,  ruby,  ruby on rails, java | programming languages,  performance optimization,  web servers, cloud,  web,  type system,  application, web servers, developer tools, web development,  cloud,  server, security,  developer tools, programming language | Programming Languages and Development Tools | 2023 |
| Ruby on Rails | 6 | html, rubyonrails, ruby | web development, web applications, web, full stack | Web | 2018 |
| Ruby Science Foundation | 6 | cprogramming, machinelearning, web, ruby, ai, jruby, c, c/c++, science, cuda, c++, data, gpu | visualization, web, compilers, data science, parallel algorithms,  scientific visualization, data-science, linear algebra, scientific computing, package management, science, artificial intelligence, space, data, hpc, math | Science and Medicine | 2019 |
| Ruby Science Foundation (SciRuby) | 1 |  |  |  | 2014 |
| Sage Mathematical Software System | 7 | cython, python, python3, c, javascript, c/c++, c++ | combinatorics, toolbox, algorithms, science, mathematics, mathematical software, math | Science and Medicine | 2018 |
| SageMath | 6 | cython, python,  cython |  math,  education,  research, research, mathematics, education, math | Science and Medicine | 2024 |
| Sahana | 1 |  |  |  | 2009 |
...
| Samba | 10 | smb, python, c,  cifs, cifs,  smb | networks, interoperability,  networking, networking,  enterprise, samba | Data and Databases | 2021 |
| Saros | 1 |  |  |  | 2015 |
| Scaffold Hunter | 2 |  |  |  | 2014 |
| Scala | 3 | llvm, scala, jvm | programming languages, compiler, programming-language, compilers, programming-tools, programming tools, functional-programming, functional programming | Programming Languages and Development Tools | 2018 |
| Scala Center | 4 |  #scala_lang,  #jvm, #scala,  #llvm,  #js,  scala.js,  scala native, scala |  #education, #compilers,  tooling,  compilers,  #functional-programming,  #programming-tools, education,  #programming-languages |  | 2024 |
| Scala Team | 4 |  |  |  | 2015 |
| Scalable Parallel Computing Laboratory | 2 |  mpi, python,  aws,  c++,  Serverless | programming languages,  high-performance computing,  parallel computing,  Serverless Computing,  faas |  | 2024 |
| Scilab | 4 | python, c, c++, opengl, scilab, java | scientific visualization, numerical computing, numerical computation, science, graphics, mathematics, programming language | End User Applications | 2018 |
| Scilab Consortium/Digiteo Foundation | 1 |  |  |  | 2010 |
| Scilab Enterprises | 2 | c, fortran, c++, scilab, java | vision, engineering, user interface, graphics, mechanics | Science and Medicine | 2016 |
| Scilab/Digiteo Foundation | 1 |  |  |  | 2009 |
| SCons next-generation build system | 1 |  |  |  | 2009 |
| SCoRe Lab | 4 |  nodejs,  android, python, machinelearning,  java, cloud,  reactjs, webdevelopment, mobile,  golang,  go | machine learning,  mobile,  web development, cloud,  machine learning, web development, mobile, information security,  cloud,  ai,  information security, security | End User Applications | 2023 |
...
| Scribus | 1 |  |  |  | 2012 |
| Scribus Team | 2 |  |  |  | 2011 |
| ScummVM | 15 |  lua,  opengl, python, sdl,  assembly, lua, c/c++,  c++, assembly, c++,  sdl, opengl,  php | engines, game, game engines, software archeology,  software preservation, software preservation,  game engines, games,  software archeology | End User Applications | 2024 |
| SeaQL | 1 | mysql,  postgresql,  llvm,  rust,  sql | database,  library,  sql,  rust,  Debugger |  | 2022 |
...
| Shaka Player | 1 | python,  javascript,  web development,  video codecs,  ui/ux | web,  streaming,  video |  | 2021 |
| SharpDevelop | 2 |  |  |  | 2010 |
...
| Shogun Machine Learning Toolbox | 5 | python, machinelearning, cmake, swig, c/c++, c++ | machine learning, statistics,  statistics, fast algorithms,  bioinformatics, bioinformatics,  fast algorithms, software engineering,  software engineering | Science and Medicine | 2017 |
...
| Sigmah | 5 | postgresql, java, gwt | project-management, humanitarian, hfoss | End User Applications | 2017 |
| SilverStripe | 1 |  |  |  | 2012 |
| Simple DirectMedia Layer | 4 |  |  |  | 2013 |
| SimpleCV | 2 |  |  |  | 2013 |
| SIP Communicator | 2 |  |  |  | 2010 |
| sktime | 2 |  sphinx,  github, python,  scikit-learn | data science,  toolbox frameworks,  time series,  ai |  | 2024 |
| Society for Arts and Technology (SAT) | 2 |  opengl, python,  javascript,  c++,  supercollider | web,  multimedia,  graphics,  cloud,  accessibility |  | 2023 |
| Software and Computational Systems Lab at LMU Munich | 4 |  java, java, python, javascript | software analysis, software verification, result presentation,  formal methods,  benchmarking, smt solver, benchmarking,  SAT & SMT solving,  program analysis | Programming Languages and Development Tools | 2024 |
| Software Freedom Conservancy, Inc. | 1 |  |  |  | 2014 |
| Software Heritage | 3 |  elasticsearch,  postgresql, postgres, python,  django, django,  javascript, javascript,  git, git | digital preservation, big data,  big code,  floss, source code archive, big code, free and open source software,  digital preservation,  source code management | Data and Databases | 2022 |
...
| SPDX | 5 | xml, python, json,  java,  golang,  rdf, rdf, node.js, golang,  json,  go, java |  compliance,  data,  licensing,  vulnerabilities, open source,  standards, licensing, compliance, security | Other | 2023 |
...
| SQLancer | 1 | java,  sql | fuzzing,  Automated Testing,  Logic bugs,  Database systems |  | 2023 |
| Statistics Online Computational Resource | 1 |  |  |  | 2012 |
| StatusNet | 2 |  |  |  | 2011 |
| stdlib | 1 | c,  javascript,  node.js,  typescript | mathematics,  web,  scientific computing,  numerical computing,  statistics |  | 2024 |
| STE  AR Group | 7 | cpp, hpc, python, opencv,  hpc, c++17parallelstl, boost, cuda, c++,  c++, hpx,  boost, parallelalgorithms | high performance computing, parallel algorithms,  parallelism, asynchronous manytask systems, hpc, asynchronous many task systems,  parallel algorithms, algorithms,  high-performance computing, runtime systems,  optimization, deep learning,  application,  concurrency,  hpx,  runtime systems, c++ standardizaion, parallel computing, distributed datastructures, library, machine learning | Programming Languages and Development Tools | 2024 |
...
| Stichting SU2 | 1 | python,  c++ | aerodynamics,  Computational Fluid Dynamics,  Multi-Disciplinary Optimization,  Adjoint Design Optimization,  Fluid Dynamics |  | 2024 |
| Stony Brook University Biomedical Informatics | 3 | matlab, apachespark, python, bigdata, javascript, hadoop, medicalimaging, c++, bioinformatics | biomedical data science, big data, imaging, genomics, bioinformtics, biomedical informatics, deep learning, cancer informatics, database, medical imaging | Science and Medicine | 2018 |
| strace | 10 | awk, c, shell,  shell script,  git, shellscript,  linux,  shell, make, linux,  make, git,  autotools,  gawk | tracing, syscall, debugging,  diagnostic, c, diagnostic,  tracing, linux, git | Operating Systems | 2023 |
| Stratosphere Laboratory, Czech Technical University in Prague | 2 |  textual, python,  docker,  redis | machine learning,  Security Defense,  civil society,  network security |  | 2024 |
...
| Submitty | 6 |  postgresql, python, php,  javascript, postgresql, javascript, databases, c++, web/html/css,  c++, php/javascript/ajax,  php | communication,  visualization, data visualization, visualization, web, privacy/security,  web,  privacy/security, education,  communication | Other | 2024 |
| Subsurface | 2 |  |  |  | 2015 |
| Subversion | 1 |  |  |  | 2009 |
| Sugar Labs | 13 |  typescript, python,  python gtk, gtk, c, javascript,  react,  gtk, gtk+, android, pygame,  vue.js,  javascipt | learning,  games,  desktop, media,  software, user interface,  open source, programming, games, stem, education,  learning,  collaboration | End User Applications | 2024 |
| Sugar Labs educational platform (a member of the SFC) | 1 |  |  |  | 2009 |
| Sunlight Foundation | 1 |  |  |  | 2009 |
| Sunlight Labs | 2 |  |  |  | 2011 |
| SuperTuxKart | 2 |  |  |  | 2014 |
| Sustainable Computing Research Group ( SCoRe ) | 4 | python, gcp, go, pyth, hadoop, golang, android, node, golan, java | mobile applications, machine learning, iot, cloud with google computer engine, web, forensic, embedded systems, mobile, security | Web | 2018 |
| Swathanthra Malayalam Computing | 2 |  |  |  | 2014 |
| Swift | 7 | llvm, cmake, compilers,  cmake,  swift, server, programminglanguages, c++, ios,  c++, swift |  Standard Libraries, programming languages,  programming languages and development tools,  programming libraries, compilers,  cross-platform,  Server development,  debugging,  package management, developer tools, programming,  Packages | Programming Languages and Development Tools | 2024 |
| SWIG | 2 |  |  |  | 2012 |
| SymbiFlow | 3 | python, fpga,  verilog, c/c++,  fpga, xilinx, verilog,  c/c++ | programming languages, programming languages and development tools, fpga, electronic design tools,  development tools,  open hardware | Programming Languages and Development Tools | 2021 |
| SymPy | 13 |  jupyter,  numpy, python, c++ |  science, physics,  symbolic mathematics, mathematics, science,  physics, computer algebra, symbolic mathematics, math | Science and Medicine | 2024 |
| SyncDiff(erent) | 1 |  |  |  | 2014 |
| Synfig | 6 | python,  gtkmm, gtk,  c++11,  gtk, c++,  c++, gtkmm |  2d animation, animation,  vector graphics,  animation, vector graphics, 2d/3d graphics | Graphics / Video / Audio / Virtual Reality | 2024 |
| syslog-ng | 4 | elasticsearch, kafka,  elasticsearch,  sql, python, json,  kafka, c,  python, sql, rest | build tools, reliable log transfer,  logging, high performance data processing,  data processing pipeline,  high performance data processing,  high-performance data processing, cloud,  reliable log transfer, log management,  cloud, logging, data processing pipeline | Other | 2022 |
| Systers | 1 |  |  |  | 2012 |
| Systers Community | 1 | ios, android, python, rubyonrails, javascript | mobile applications,  web apps, community | Other | 2018 |
| Systers, an Anita Borg Institute Community | 5 | python, rubyonrails, mysql, javascript, android, ios, java | web, women in open source, women in tech, mobile, games, peace corps, systers | Other | 2017 |
| Systers: Women in Computing | 2 |  |  |  | 2010 |
| Tahoe-LAFS | 1 |  |  |  | 2010 |
| Tarantool | 2 |  lua,  sql, c,  python,  c++ |  algorithms, distributed systems,  In-memory,  IMDG,  high performance data processing,  JIT, sql,  in-memory data grid,  NoSQL Database |  | 2022 |
| TARDIS RT Collaboration | 3 | python,  jupyter,  numpy,  numba,  pandas |  astrophysics,  big data,  simulation, visualization |  | 2024 |
| TARDIS SN | 4 | cython, python,  jupyter,  numpy, c,  numba,  pandas | astronomy, visualization,  simulation, supernova,  big data, science,  astrophysics, monte carlo methods, global optimization, radiative transfer | Science and Medicine | 2021 |
| Tcl Community Association | 1 |  |  |  | 2009 |
| Tcl/Tk Community | 2 |  |  |  | 2011 |
| TEAMMATES @ National University of Singapore | 4 | css, javascript, googleappengine, html, appengine, javaee, java | teaching, software as a service, webapps, peer feedback, cloud, saas, web applications, web development, learning management, education | Web | 2018 |
| TEAMMATES Project @ National University of Singapore | 1 |  |  |  | 2014 |
| TensorFlow | 5 | machine learning, python, machinelearning, deeplearning,  Jax,  python deep learning frameworks, javascript, c/c++,  keras, dataanalysis,  ai,  tensorflow,  c/c++ | machine learning, python,  deep learning,  on-device machine learning, data science,  machine learning, deep learning,  computer vision,  research,  cloud computing, education,  natural language processing, data | Other | 2023 |
| The Apache Software Foundation | 4 |  java, c, c/c++, c++,  c++,  rust, java | libraries, big data,  libraries, cloud,  big data,  cloud | Programming Languages and Development Tools | 2021 |
| The Apertium Project | 2 | xml, python, perl, finite-statetechnologies, c++ | morphological analysis, human language technologies, computer-aided translation, natural language processing, machine translation | Social / Communications | 2016 |
| The Aqsis Team | 1 |  |  |  | 2009 |
| The Asterisk Project | 2 |  |  |  | 2010 |
| The Battle for Wesnoth | 1 |  |  |  | 2011 |
| The Center for Connected Learning and Computer-Based Modeling | 4 | css, html5/css3, javascript, html5, scala, java | programming languages,  education, simulation, science,  research, research, academic research, education, programming language | Programming Languages and Development Tools | 2019 |
| The Centre for Computational Medicine | 1 |  |  |  | 2013 |
| The CGAL Project | 3 | github, git, c++ | computational geometry, mesh processing, geometry processing, triangulaton, arrangement | Science and Medicine | 2017 |
| The Codehaus | 3 |  |  |  | 2011 |
| The Concord Consortium | 4 |  |  |  | 2015 |
| The Eclipse Foundation  | 9 | iot, php, geo, openj9, javascript, c/c++, xtext, jakarta, che, ide, java | iot, runtimes, industry, developer tools, cloud, runtime systems, research, locationtech, internet of things, ide, frameworks | Programming Languages and Development Tools | 2019 |
| The Electronic Frontier Foundation/The Tor Project | 1 |  |  |  | 2009 |
| The ENIGMA Team | 4 |  opengl,  qt5,  recursive-descent, android,  c++, opengl |  game development,  compiler, graphics,  game design,  programming |  | 2024 |
| The Enlightenment Project | 1 |  |  |  | 2009 |
| The Fedora Project | 5 |  |  |  | 2015 |
| The FreeBSD Project | 5 |  llvm, c,  assembly,  POSIX shell,  make |  Embedded System, virtualization,  operating system |  | 2024 |
...
| The GNU Project | 4 | guile, scheme, python, operatingsystems, c, javascript, c/c++, android | astronomy, gnu, http, reverse engineering, operating system, package managers, free software, operating systems | Operating Systems | 2020 |
| The Honeynet Project | 15 |  django, python,  javascript, c,  python,  c++, machinelearning, go,  docker, linux, html/javascript, honeypots, javascript, networkstack, python3, c/c++, networking, golang, honeypot, android, dataanalysis,  go | honeypots,  hypervisor introspection, deception, honeynet,  Threat Intelligence, honeynets, sandbox, malware, networking, fuzzing,  network analysis, web development, research, honeypot,  honeypot,  malware analysis, security | Security | 2024 |
| The Java Pathfinder Team | 8 | javajava, jvm, bytecode, android, distributedsystems, java | symbolic execution, model checking, test input generation, formal methods, program analysis,  verification ,  environment generation, testing, software model checking,  model checking, virtual machine, concurrency,  symbolic execution,  verification of concurrent systems,  test input generation,  testing , program analysis  | Programming Languages and Development Tools | 2020 |
| The JPF team | 3 |  distributed systems,  jvm,  smt solvers,  java, android | model checking,  verification of concurrent systems,  test input generation,  symbolic execution,  program analysis |  | 2024 |
| The Julia Language | 9 | llvm, julia, machine learning,  julia,  garbage-collection, javascript, c,  compilers, c/c++,  data science, atom, c++, julialang, gpu | machine learning, numerical computing, statistics, data science, high performance computing, linear algebra,  science,  graphs, numerical computation, scientific computing,  data science,  machine learning, graphics, technical computing, plotting, integrated development environments, math | Programming Languages and Development Tools | 2024 |
| The Libreswan Project | 6 | virtualization, python,  kvm, nss, web,  RFCs, c, qemu,  python, shellscript,  namespaces,  shell |  ipsec, vpn, encryption,  vpn, ike,  encryption, ipsec vpn, ikev2, ipsec, security,  ikev2 | Security | 2022 |
| The Linux Foundation | 15 | python,  cups, mysql, gtk, c,  linux, cups,  ipp, c++,  c++, ipp |  zephyr, lsb, spdx,  automotive, printing, wireguard, kernel,  iio,  printing, wireless,  lsb, automotive | Operating Systems | 2024 |
| The LLVM Compiler Infrastructure | 5 | llvm,  llvm, clang, c,  clang, c/c++,  mlir, mlir, c++ | compiler, programming languages and development tools, compilers, code analysis, static code analysis, frontend,  debuggers,  code analysis, debuggers, optimization, backend | Programming Languages and Development Tools | 2021 |
| The MacPorts Project | 7 | html/javascript, frontend, react.js, vue.js, tcl, make, git | build tools, mac os x, command line, macos, package manager | End User Applications | 2018 |
| The Mifos Initiative | 6 | mysql, spring,  java,  spring, angularjs,  angular, angular,  kotlin, android, java | fintech, digital financial services, microfinance, web, mobile banking, ai, big data,  mobile banking,  fintech, cloud, artificial intelligence,  financial inclusion, financial inclusion,  cloud | End User Applications | 2024 |
...
| The NetBSD Foundation | 13 | virtualization, cprogramming, networkstack,  bsd, c,  unix, bsd, kernel, arm, mips, networking, filesystems, bsdmake, make,  shell script,  bsd unix, security,  make | general purpose os, packaging,  bsd, userland, kernel, package system, bsd,  packaging,  unix, package management, operating systems, free and open source software, unix, real unix,  userland | Operating Systems | 2024 |
| The NetBSD Project | 1 |  |  |  | 2009 |
| The ns-3 Network Simulator Project | 14 |  django, python,  c++, c/c++, c++,  python 3 | computer networking, network simulation, simulation,  networking, research and development,  emulation, networking,  network simulation,  network analysis, research | Other | 2024 |
...
| The P4 Language Consortium | 1 | c++,  cmake,  bazel,  grpc,  protobuf | networking,  programming language,  compiler,  formal verification,  programmable data plane |  | 2024 |
| The Palisadoes Foundation | 4 |  graphql,  typescript,  mongodb, javascript,  reactjs,  node.js,  MERN,  flutter, flutter |  api,  mobile, web,  social impact,  social good,  mobile apps, web development,  cloud computing,  ai,  database |  | 2024 |
| The Perl Foundation | 5 | perl5, perl, regularexpressions, c, perl6 | programming languages and development tools, concurrency, web services, natural language understanding, functional programming | Programming Languages and Development Tools | 2019 |
...
| The Processing Foundation | 5 | python, javascript, android, opengl, java | creative coding, web,  education,  web,  graphics, graphics, education,  design, design | Programming Languages and Development Tools | 2019 |
...
| The R Project for Statistical Computing | 1 | javascript,  c/c++,  r-project,  fortran | visualization,  machine learning,  data science,  graphics,  statistics |  | 2021 |
| The Rust Foundation | 1 | python,  rust | compilers,  programming languages |  | 2024 |
| The STE  AR Group | 3 | highperformancecomputing, parallelprocessing, cuda, c++, opencl | high performance computing, parallel computing, runtime systems, hpx, gpu | Programming Languages and Development Tools | 2016 |
| The Syslinux Project | 1 |  |  |  | 2009 |
| The syslog-ng project | 4 | elasticsearch, python, rest, c, bigdata, c/c++, rust, java | python, continuous delivery, message queue, message correlation, data extraction, log management, logging | Security | 2018 |
| The Terasology Foundation | 3 | lwgjl,  opengl,  gradle, lwjgl, blender,  lwjgl,  kotlin, opengl, gradle, java | game,  ai, ai, sandbox, graphics, voxel,  games,  game engines, games, minecraft,  graphics / video / audio / virtual reality, modding | End User Applications | 2021 |
| The Tor Project | 3 | browserextensions, python, c, javascript,  python,  web, golang,  rust |  privacy,  Human Rights, privacy, anonymity, research,  anti-censorship, security, anti-censorship,  Surveillance | Security | 2023 |
...
| The Wine Project | 9 | vulkan, win32, x11, c, directx, opengl | desktop integration,  opengl,  desktop integration, vulkan,  directx, 3d,  3d, directx, opengl, compatibility | Other | 2020 |
| The Wiselib | 3 |  |  |  | 2014 |
| Theoretical Biophysics @ Humboldt University | 1 |  |  |  | 2011 |
| ThinkUp | 2 |  |  |  | 2014 |
| Thousand Parsec | 2 |  |  |  | 2010 |
| Tianocore | 4 | c,  python,  rust,  uefi,  golang |  acpi,  BIOS, firmware,  open system firmware,  bootloader,  uefi,  edk2 |  | 2022 |
...
| TimVideos.us | 5 | python, fpga, vhdl, c, verilog | embedded hardware, live streaming, fpga,  embedded, video, hardware, video capture | Graphics / Video / Audio / Virtual Reality | 2019 |
...
| Tor | 2 | python, c, javascript, c++ |  counter-censorship,  anonymity, privacy, free-speech | Security | 2017 |
| Tox | 1 |  |  |  | 2015 |
...
| Ubuntu | 1 |  |  |  | 2010 |
| UC OSPO | 3 | python,  verilog,  machine learning,  c/c++,  VLSI |  hardware,  AI/ML, education,  storage,  I/O |  | 2024 |
| UCSC Xena | 3 | python, clojure, javascript, jvm, react, d3 | data visualization, cancer,  scientific visualization,  bioinformatics, cancer research, genomics, web application, web applications, bioinformatics | Science and Medicine | 2019 |
| Umit Project | 3 |  |  |  | 2012 |
| Unicode, Inc. | 1 | java,  c++,  rust,  unicode | compilers,  linguistics,  languages,  internationalization |  | 2024 |
| Unikraft | 3 |  kvm, c,  xen,  golang,  assembly language | virtualization,  software reuse,  cloud,  software configurability |  | 2024 |
...
| Uramaki LAB | 1 | python,  javascript,  html,  css,  Firebase | Usability,  User Evaluation,  Heuristic Evaluation,  Eye Tracking,  Sentimental Analysis |  | 2024 |
| Urban Energy Systems Laboratory, Empa | 2 | fastfluiddynamics, milp, gis, python | distributed energy systems, data portal, modeling & optimization, simulation, data analysis, energy | Science and Medicine | 2017 |
| Ushahidi | 1 |  |  |  | 2010 |
...
| VideoLAN | 11 | c#,  video codecs, c++, qt,  video, vue.js, c, go,  assembly, opengl,  machine learning, asm,  qt,  audio,  c++, assembly | vr, web, multimedia,  multimedia, codecs,  video, audio,  video decode, video, 3d,  video processing,  network programming,  streaming, graphics,  codecs,  media database | Graphics / Video / Audio / Virtual Reality | 2024 |
...
| ViSP | 2 | c/c++, vision, c++ | robotics, vision, computer vision | Graphics / Video / Audio / Virtual Reality | 2018 |
| Visualization Toolkit (VTK) | 2 |  |  |  | 2014 |
| vitrivr | 3 |  typescript, machinelearning, web, computervision, grpc, angularjs, databases,  angular, spark,  kotlin,  tensorflow, java | multimedia retrieval, retrieval, multimedia, audio, video, 3d, databases,  web,  machine learning,  computer vision,  multimedia retrieval | Data and Databases | 2021 |
| Wagtail | 3 |  django, python,  javascript |  cms,  accessibility, web |  | 2024 |
| Waycrate | 1 | c,  c++,  rust,  wayland,  Zig | graphics,  Wayland,  ScreenCapture,  Wayland Compositor,  Desktop Portals |  | 2024 |
| Wayland | 1 | opengl, wayland, c, xml, kms | graphics, window system, display, video | Graphics / Video / Audio / Virtual Reality | 2016 |
| Weaviate | 1 | python,  machine learning,  golang,  vectors,  natural language processing | machine learning,  Vector Database,  Search Engines |  | 2022 |
| webpack | 4 | webassembly,  typescript, webasssembly, html5/css3, javascript, node.js, webdevelopment,  node, webpack | web performance, programming languages and development tools, compilers,  javascript, parser,  webassembly,  Node.js, toolchains, web development, tooling,  webpack | Programming Languages and Development Tools | 2024 |
| Wellcome Sanger Tree of Life | 2 |  opengl, python,  groovy,  nextflow,  rust | machine learning,  genome assembly,  bioinformatics,  genomics,  genome analysis |  | 2024 |
| Wikimedia | 2 |  |  |  | 2014 |
| Wikimedia Foundation | 14 | reactjs,  css, python, rubyonrails, jquery, php, css,  javascript, javascript,  Phyton, android, html,  html,  php | wiki, web, i18n, encyclopedia,  wikipedia,  mediawiki,  wiki,  i18n,  wikimedia,  semantic web,  web, wikipedia, wikimedia, education, mediawiki, input methods, semantic web | Web | 2024 |
| Wine | 1 |  |  |  | 2011 |
| Wine (a project of Software Freedom Conservancy)  | 1 |  |  |  | 2012 |
| Wine Project | 1 |  |  |  | 2013 |
| WinLibre | 1 |  |  |  | 2009 |
| Wireshark | 2 | cmake, qt, lua, c/c++, pcap | data visualization, network security, network monitoring | Security | 2020 |
| WordPress | 5 |  |  |  | 2014 |
...
| WorldForge | 6 |  |  |  | 2014 |
| WSO2 | 4 | distributedcomputing, webservices, soa, middleware, java | iot, micro services, cloud, data analysis, api management, security | Other | 2017 |
| wxWidgets | 5 | win32, c++, cocoa, gtk+ | gui, desktop, cross-platform | Programming Languages and Development Tools | 2017 |
| X.Org | 2 |  |  |  | 2010 |
| X.Org Foundation | 11 | wayland, vulkan,  x11, x11, c,  vulkan,  wayland,  DRM, c++, opencl, opengl | windowing system, media acceleration, 3d acceleration, 2d acceleration, gpu, graphics stack, graphic stack, operating system, video, 3d, windowing systems,  kernel, graphics, testing/ci,  drivers, 2d/3d graphics | Graphics / Video / Audio / Virtual Reality | 2023 |
| Xapian Search Engine Library | 8 | unicode, swig, linux, golang, c++, android | machine learning, search, indexing, linguistics, information retrieval, integration | Data and Databases | 2020 |
| XBMC | 1 |  |  |  | 2013 |
| XBMC Foundation | 4 | xml, drupal, python, mysql, c/c++, github, c++11, git | video player, media center, audio, video, home theater, media management | Graphics / Video / Audio / Virtual Reality | 2018 |
| Xelerance Corporation | 1 |  |  |  | 2009 |
| Xen Project | 2 | free/netbsd, asm/c/c++, qemu, ocaml, linux | virtualization, embedded/automotive, cloud computing, unikernels, security | Cloud | 2017 |
| xen.org | 2 |  |  |  | 2011 |
| Xfce | 2 |  javascript, c,  python,  vala,  gtk | gui,  customization,  desktop environment, desktop |  | 2022 |
...
| Xiph.Org Foundation | 3 |  x86,  assembly,  arm, rust,  c language |  multimedia,  video decode, video,  video encode |  | 2021 |
| XMMS2 | 2 |  |  |  | 2010 |
| XMMS2 - X-platform Music Multiplexing System 2 | 1 |  |  |  | 2011 |
| XMPP Standards Foundation | 8 | xmpp,  xmpp, erlang, gtk, webrtc, javascript,  swift, lua, vala,  vala,  Objective C, c++, java | voip, chat, instant messaging, realtime communication, messaging,  Jingle,  Real-Time Communication, social,  chat,  WebRTC, communications | Social / Communications | 2023 |
...
| xrdesktop | 1 | c,  vulkan,  wayland,  glib,  openxr | virtual reality,  graphics,  real time,  3dui,  window management |  | 2021 |
| XWiki | 11 |  velocity,  html5,  css3,  java, css, javascript, css3, html5, velocity, java | wiki, structured data,  structured data, web platform and services,  wiki,  platform, platform, web development, web applications,  web applications,  web platform and services, extensions | Web | 2023 |
| YafaRay (Yet Another Free Raytracer) | 1 |  |  |  | 2010 |
| Zendalona | 1 | python,  javascript,  android,  gtk,  qt | web,  gui,  accessibility,  braille,  gaming |  | 2024 |
...
| Zulip | 7 | electron,  css,  django,  typescript, python,  react native, django, typescript, javascript,  electron, reactnative,  flutter | cross-platform, great developer tooling, group chat, mobile applications,  great developer tooling, team chat, bots, chat,  integrations, enterprise,  visual design, web development, mobile,  teaching quality codebase,  team chat,  chat, visual design | Social / Communications | 2024 |
| Zulip Open Source Project | 2 | electron, python, django, javascript, ios, reactnative, android | great developer tooling, group chat, bots, chat, mobile, high quality codebase, visual design, full stack web and mobile | Social / Communications | 2019 |
